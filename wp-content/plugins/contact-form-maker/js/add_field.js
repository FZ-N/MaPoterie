...
function type_captcha(i,w_field_label, w_field_label_size, w_field_label_pos, w_hide_label, w_digit, w_class, w_attr_name, w_attr_value) {
  ...
  adding.setAttribute("src", url_for_ajax + "?action=formmakerwdcaptcha_fmc&nonce=" + fm_ajax.ajaxnonce + "&digit=" + w_digit + "&i=form_id_temp");
...
function change_arithmetic_captcha(value, field) {
  ...
  arithmetic_captcha.setAttribute("src", url_for_ajax + "?action=formmakerwdmathcaptcha_fmc&operations_count=" + oper_count + "&nonce=" + fm_ajax.ajaxnonce + "&operations=" + operations.replace('+', '@') + "&i=form_id_temp");
}
...
function type_arithmetic_captcha(i,w_field_label, w_field_label_size, w_field_label_pos, w_hide_label, w_count, w_operations, w_class, w_input_size, w_attr_name, w_attr_value) {
  ...
  adding.setAttribute("src", url_for_ajax + "?action=formmakerwdmathcaptcha_fmc&operations_count=" + w_count + "&nonce=" + fm_ajax.ajaxnonce + "&operations=" + w_operations.replace("+", "@") + "&i=form_id_temp");
