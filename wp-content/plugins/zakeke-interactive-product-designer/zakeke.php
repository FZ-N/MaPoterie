...
if ( ! class_exists( 'Zakeke' ) ) :
	...
	final class Zakeke {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'zakeke' ), '1.0' );
		}
		...
		private static function woocommerce_did_load() {
		    return function_exists( 'WC' ) && version_compare( WC()->version, 2.6, '>=' );
        }
		...
		private function define_constants() {
            ...
            $this->define( 'ZAKEKE_BASE_URL', 'https://www.zakeke.com' );
		...
		public static function plugin_row_meta( $links, $file ) {
			if ( plugin_basename( __FILE__ ) == $file ) {
                $row_meta = array(
                    'docs' => '<a href="https://www.zakeke.com/Documentation/Integration/WooCommerce?utm_medium=plugin&utm_campaign=zakeke_processo_installazione" target="_blank" aria-label="' . esc_attr__( 'View Zakeke documentation',
                            'zakeke' ) . '">' . esc_html__( 'Documentation', 'zakeke' ) . '</a>',
                    'register' => '<a href="https://www.zakeke.com/Admin/Register?utm_medium=plugin&utm_campaign=zakeke_processo_installazione" target="_blank" aria-label="' . esc_attr__( 'Register to Zakeke',
