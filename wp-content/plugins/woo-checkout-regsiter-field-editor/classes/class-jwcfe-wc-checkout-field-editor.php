...
class JWCFE_WC_Checkout_Field_Editor {
	...
	function enqueue_admin_scripts() {
		...
		wp_enqueue_script( 'jwcfe-admin-script', plugins_url('/assets/js/jwcfe-admin.js', dirname(__FILE__)), array('jquery','jquery-ui-dialog', 'jquery-ui-sortable',
	...
	function jwcfe_checkout_fields_select_field( $field = '', $key, $args, $value ) {
		...
		$options = '';
		$options .= '<option disabled selected value>' . esc_html__( 'Please Select option', 'jwcfe' ) .'</option>';
		if ( ! empty( $args['options'] ) ) {
			foreach ( $args['options'] as $option_key => $option_text ) {
				$options .= '<option '. selected( $value, $option_key, false ) . '>' . __( $option_text, 'jwcfe' ) .'</option>';
			}
	...
	function jwcfe_new_field_form_pp(){
		...
		?>
        <div id="jwcfe_new_field_form_pp" title="New Checkout Field" class="jwcfe_popup_wrapper">
          <form>
          	<table>
            	<tr>                
            	...
            	<tr>                    
                	<td width="40%"><?php esc_html_e('Type','jwcfe'); ?></td>
                    <td>
						...
						<option disabled><?php esc_html_e('Heading - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('Number - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('File Upload - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('Multi-Select - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('Checkbox - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('Radio Button - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('Date Picker - (Premium Feature)','jwcfe'); ?></option>
						<option disabled><?php esc_html_e('password - (Premium Feature)','jwcfe'); ?><font color="red"></option>
            	...
            	<tr class="rowName">                
                    ...
                    <td><input type="text" name="fname" placeholder="eg. new_field" style="width:250px;"/></td>
				</tr>         
                <tr class="rowLabel">
                ...
                <tr class="rowOptions">                    
					...
					<br><span><?php esc_html_e(' add comma separated options', 'jwcfe'); ?></span></td>
				</tr>
                <tr class="rowClass">
	...
	function jwcfe_edit_field_form_pp(){
		$field_types = $this->get_field_types();
		?>
        <div id="jwcfe_edit_field_form_pp" title="Edit Checkout Field" class="jwcfe_popup_wrapper">
          <form>
          	<table>
            	<tr>                
                	<td colspan="2" class="err_msgs"></td>
                ...
                <tr>                   
                    <td><?php esc_html_e('Type','jwcfe'); ?></td>
                    <td>
                    	<select name="ftype" style="width:250px;" onchange="fieldTypeChangeListner(this)">
                        <?php foreach($field_types as $value=>$label){ ?>
                        	<option value="<?php echo trim($value); ?>"><?php echo $label; ?></option>
