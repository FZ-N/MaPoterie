...
class Smart_Manager_Admin_Welcome {
	...
	public function show_welcome_page() {
		...
		<script type="text/javascript">
			jQuery(document).on('ready', function() {
				jQuery('#toplevel_page_smart-manager').find('a[href$=sm-about]').addClass('current');
				jQuery('#toplevel_page_smart-manager').find('a[href$=sm-faqs]').addClass('current');
	...
	function smart_manager_support_ticket_content() {
		...
		StoreApps_Upgrade_3_2::support_ticket_content( self::$prefix, self::$sku, $plugin_data, $license_key, 'smart-manager-for-wp-e-commerce' );
	}
	...
	private function intro() {
		...
		<div id="sm_welcome_feature_section" class="feature-section col two-col">
			<div class="col">
			...
			<div class="col last-feature">
				<p align="right">
					...
					<?php if ( SMBETAPRO === true ) { ?>
						<a href="options-general.php?page=smart-manager-settings" target="_blank"><?php _e( 'Settings', 'smart-manager-for-wp-e-commerce' ); ?></a> | 
					<?php } ?>
					<a href="https://www.storeapps.org/knowledgebase_category/smart-manager/?utm_source=sm&utm_medium=welcome_page&utm_campaign=view_docs" target="_blank"><?php _e( 'Docs', 'smart-manager-for-wp-e-commerce' ); ?></a>
				</p>
			</div>
		</div>
		<br>
	...
	public function about_screen() {
		...
		<div class="wrap sm-welcome about-wrap">
			...
			<?php $this->intro();?>
			<div>
				<p><?php echo __( 'Smart Manager is a unique, revolutionary tool that gives you the power to <b>boost your productivity by 10x</b> in managing your store by using a using a <b>familiar, single page, spreadsheet like interface</b>. ', 'smart-manager-for-wp-e-commerce' ); ?></p>
			...
			<div>
				<center><h3><?php echo __( 'Manage your entire store from a single screen', 'smart-manager-for-wp-e-commerce' ); ?></h3></center>
				<div class="feature-section col three-col" >
					<div class="col">
						<h4><?php echo __( 'Filter / Search Records', 'smart-manager-for-wp-e-commerce' ); ?></h4>
						<p>
					...
					<div class="col">
						<h4><?php echo __( 'Inline Editing', 'smart-manager-for-wp-e-commerce' ); ?></h4>
						<p>
					...
					<div class="last-feature col">
						<h4><?php echo sprintf(__( 'Manage everything related to WordPress %s', 'smart-manager-for-wp-e-commerce' ), '<sup style="vertical-align:super;color: red;font-size:1em;">' . __( 'New', 'smart-manager-for-wp-e-commerce' ) . '</sup>' ); ?></h4>
						<p>
							<?php echo sprintf(__( 'Apart from WooCommerce post types like Products, Orders, Coupons, now you can manage %s. Be it Posts, Pages, Media, WordPress Users or any custom post types in WordPress, you can now manage everything using Smart Manager.', 'smart-manager-for-wp-e-commerce' ), '<strong>' . __( 'any custom post type in WordPress', 'smart-manager-for-wp-e-commerce' ) . '</strong>' ); ?>
						</p>
					</div>
				</div>
				<div class="feature-section col three-col" >
					<div class="col">
						<h4>
							<?php 
								if ( SMBETAPRO === true ) {
									echo __( 'Duplicate Records', 'smart-manager-for-wp-e-commerce' );											
								} else {
									echo sprintf(__( 'Duplicate records (only in %s)', 'smart-manager-for-wp-e-commerce' ), '<a href="https://www.storeapps.org/product/smart-manager/?utm_source=sm&utm_medium=welcome_page&utm_campaign=sm_know" target="_blank">' . __( 'Pro', 'smart-manager-for-wp-e-commerce' ) . '</a>' );
								}
							?>
						</h4>
						<p>
							<?php echo sprintf(__( 'You can duplicate records of the entire store OR selected records by simply selecting the record and then click on Duplicate. %s.', 'smart-manager-for-wp-e-commerce' ), '<a href="https://www.storeapps.org/docs/sm-how-to-duplicate-products/?utm_source=sm&utm_medium=welcome_page&utm_campaign=sm_know" target="_blank">' . __( 'See how', 'smart-manager-for-wp-e-commerce' ) . '</a>' ); ?>
						</p>
					</div>
					<div class="col">
						<h4>
	...
	public function faqs_screen() {
		...
		<div class="wrap sm-welcome about-wrap">
			...
			<h3><?php echo __( "FAQ / Common Problems", 'smart-manager-for-wp-e-commerce' ); ?></h3>
			...
			<?php
				...
				if ( SMBETAPRO === true ) {
					$faqs[] = array(
									...
									'ans' => sprintf(__( 'Smart Manager is actively developed. If you can\'t find your favorite feature (or have a suggestion) %s. We\'d love to hear from you.', 'smart-manager-for-wp-e-commerce' ), '<a class="thickbox" href="' . admin_url('#TB_inline?inlineId=sa_smart_manager_beta_form_post_query&height=550') .'" title="' . __( 'Submit your query', 'smart-manager-for-wp-e-commerce' ) .'">' . __( 'contact us', 'smart-manager-for-wp-e-commerce' ) . '</a>' )
								);
				} else {
					$faqs[] = array(
